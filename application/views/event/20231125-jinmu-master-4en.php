        ...
        <br />
                <div class='row text-center'>
                    <div class='col-lg-10 col-lg-offset-1 col-xs-10 col-xs-offset-1'>
                        ...
                        <div class='row'>
                            <h2 class='text-center'>True Buddha Foundation Launching a Praying for Guru Buddha Event 
<br />by Supplicating Guru Buddha to Stay in the World
</h2>
                            <br /><img style='width: 100%; max-width: 920px;' src='https://en.tbsn.org/images/2023_11_07/2023-event-jinmu1-en.jpg' />
                            <br /><br /><div class='text-justify'style="color:red;font-weight: bold;">Nov. 1-30, 2023 
<br />Worldwide disciples will recite the Jade Pond Golden Mother Mantra and dedicate the merit to Guru Buddha’s health, wellbeing, longevity, and staying in the world.
</div>
                        </div>
                    ...
                    <form class='form-horizontal' method="post" action="<?= base_url('event/register/'.$event['event_id']);?>/en">
                        ...
                        <div class='row row-data'>
                            <div class='col-xs-3 col-lg-4 strong_txt text-right'>Ceremony Supporting Dharma Propagators</div>
                            <div class='col-xs-9 col-lg-6 text-left'>
                                <div class='form form-group'>
