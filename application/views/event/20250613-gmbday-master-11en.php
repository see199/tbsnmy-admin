        ...
        <br />
                <div class='row text-center'>
                    <div class='col-lg-10 col-lg-offset-1 col-xs-10 col-xs-offset-1'>
                        ...
                        <div class='row'>
                            <h2 class='text-center'>Masters Around the World Perform Golden Mother Homas or Water Offerings</h2>
...
<br />With Shared Aspirations, We Walk the Path Together
<br />
<br />Let us all turn the Dharma Wheel together.</b>
<br /> 
<br />May our five million disciples join in supplicating the Guru Buddha to stay in the world, united in heart and wish to protect this precious Dharma lineage, ensuring the Guru’s teachings remain and the Dharma Wheel continuously turns!
                    ...
                    <form class='form-horizontal' method="post" action="<?= base_url('event/register/'.$event['event_id']);?>/en">
                        ...
                        <div class='row row-data'>
                            <div class='col-xs-3 col-lg-4 strong_txt text-right'><font color='red'>*</font>Dharma Name:</div>
                            <div class='col-xs-9 col-lg-6 text-left'>
                                <div class='form form-group'>
                        ...
                        <div class='row row-data'>
                            <div class='col-xs-3 col-lg-4 strong_txt text-right'><font color='red'>*</font>Date 1:</div>
                            <div class='col-xs-9 col-lg-6 text-left'>
                                <div class='form form-group'>
