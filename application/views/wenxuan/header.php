...
<head>
    ...
    <link rel="icon" href="<?= base_url(); ?>assets/img/favicon_wenxuan.ico" type="image/x-icon">
    <link rel="shortcut icon" href="<?= base_url(); ?>assets/img/favicon_wenxuan.ico" type="image/x-icon">
