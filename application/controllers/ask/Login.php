...
class Login extends CI_Controller {
    ...
    public function index() {
        ...
        $client->setRedirectUri($this->config->item('redirect_uri_ask'));
        ...
        if ($this->input->get('code')) {
            ...
            header('Location: ' . filter_var($this->config->item('redirect_uri_ask'), FILTER_SANITIZE_URL));
        }
