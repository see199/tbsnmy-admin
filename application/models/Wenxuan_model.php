...
class Wenxuan_model extends CI_Model {
	...
	public function get_subscriber_list($year){
		...
		// Get Subscriber
		$this->db->select('s.*, y.wenxuan_id, y.package_id, y.fullpayment, y.status, y.gift_taken, y.md5_id, y.start_date, y.end_date, y.remarks, p.year, y.create_date, y.register_blessing')
			->from('tbs_wenxuan_subscriber_year y')
			->join('tbs_wenxuan_subscriber_package p','y.package_id = p.package_id', 'left')
