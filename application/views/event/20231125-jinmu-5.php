...
<body>
  ...
  <script type="text/javascript">
    ...
    const timezone_list_1 = {
        ...
        "8":   "<?= $event_1;?>（當地時間：11/24 11PM）",
        "9":   "<?= $event_1;?>（當地時間：11/25 12AM）",
        "10":  "<?= $event_1;?>（當地時間：11/25  1AM）",
        "11":  "<?= $event_1;?>（當地時間：11/25  2AM）",
    ...
    const timezone_list_2 = {
        "2":   "<?= $event_2;?>（當地時間：11/26  2AM）",
        "3":   "<?= $event_2;?>（當地時間：11/26  3AM）",
        "4":   "<?= $event_2;?>（當地時間：11/26  1AM）",
        "5":   "<?= $event_2;?>（當地時間：11/26  4AM）",
        "6":   "<?= $event_2;?>（當地時間：11/26  6AM）",
        "7":   "<?= $event_2;?>（當地時間：11/25  3PM）",
        ...
        "13":  "<?= $event_2;?>（當地時間：11/25  6PM）",
        "14":  "<?= $event_2;?>（當地時間：11/25  7PM）",
        "15":  "<?= $event_2;?>（當地時間：11/25  8PM）",
        "16":  "<?= $event_1;?>（當地時間：11/25  5AM）"
    }
