                ...
                <div class='row text-center'>
                    <div class='col-lg-10 col-lg-offset-1 col-xs-10 col-xs-offset-1'>
                        ...
                        <div class='row'>
                            ...
                            <br /><img style='width: 100%; max-width:920px;' src='https://id.tbsn.org/images/2023_04_24/1682304115154.jpg' />
...
<br />Zoom ID dan kata sandi akan dikirim ke surel, harap pastikan terlebih dahulu ketepatan alamat surel yang Anda tulis, baru kemudian menyerahkan formulir. </div>
  ...
  <script type="text/javascript">
    ...
    const timezone_list_1 = {
        "2":   "<?= $event_1;?> (Waktu Lokal: 11/25  3PM) ",
        "3":   "<?= $event_1;?> (Waktu Lokal: 11/25  4PM) ",
        "4":   "<?= $event_1;?> (Waktu Lokal: 11/25  2PM) ",
        "5":   "<?= $event_1;?> (Waktu Lokal: 11/25  5PM) ",
        "6":   "<?= $event_1;?> (Waktu Lokal: 11/25  8PM) ",
        "7":   "<?= $event_1;?> (Waktu Lokal: 11/25  4AM) ",
        "8":   "<?= $event_1;?> (Waktu Lokal: 11/24 11PM) ",
        "9":   "<?= $event_1;?> (Waktu Lokal: 11/25 12AM) ",
        "10":  "<?= $event_1;?> (Waktu Lokal: 11/25  1AM) ",
        "11":  "<?= $event_1;?> (Waktu Lokal: 11/25  2AM) ",
        "12":  "<?= $event_1;?> (Waktu Lokal: 11/24  9PM) ",
        "13":  "<?= $event_1;?> (Waktu Lokal: 11/25  7AM) ",
        "14":  "<?= $event_1;?> (Waktu Lokal: 11/25  8AM) ",
        "15":  "<?= $event_1;?> (Waktu Lokal: 11/25  9AM) ",
        "16":  "<?= $event_1;?> (Waktu Lokal: 11/25  6PM) "
    }

    const timezone_list_2 = {
        "2":   "<?= $event_2;?> (Waktu Lokal: 11/26  2AM) ",
        "3":   "<?= $event_2;?> (Waktu Lokal: 11/26  3AM) ",
        "4":   "<?= $event_2;?> (Waktu Lokal: 11/26  1AM) ",
        "5":   "<?= $event_2;?> (Waktu Lokal: 11/26  4AM) ",
        "6":   "<?= $event_2;?> (Waktu Lokal: 11/26  6AM) ",
        "7":   "<?= $event_2;?> (Waktu Lokal: 11/25  3PM) ",
        "8":   "<?= $event_2;?> (Waktu Lokal: 11/25 10AM) ",
        "9":   "<?= $event_2;?> (Waktu Lokal: 11/25 11AM) ",
        "10":  "<?= $event_2;?> (Waktu Lokal: 11/25 12PM) ",
        "11":  "<?= $event_2;?> (Waktu Lokal: 11/25  1PM) ",
        "12":  "<?= $event_2;?> (Waktu Lokal: 11/25  7AM) ",
        "13":  "<?= $event_2;?> (Waktu Lokal: 11/25  6PM) ",
        "14":  "<?= $event_2;?> (Waktu Lokal: 11/25  7PM) ",
        "15":  "<?= $event_1;?> (Waktu Lokal: 11/25  8PM) ",
        "16":  "<?= $event_2;?> (Waktu Lokal: 11/25  5AM) "
    }
