		...
		<div class='col-md-10 col-md-offset-1'>
			...
			<div class='row'><div class='col-md-12'>
					...
					<div class='col-md-6'>
						<div class='form-inline'>
							<div class='form-group'>
								<label for='contact_name'>主祈者姓名: </label>
				...
				<table class='table table-bordered' id='form-table'>
					<thead>
						<tr><th>祈福者姓名</th><th>現居地址</th><th>祈願</th></tr>
					</thead>
					<tbody>
					</tbody>
					<tfoot>
						<tr><td colspan=3><a href='javascript:void(0)' class='btn btn-default' onclick='addrow();'><span class='glyphicon glyphicon-plus-sign'> 添加更多祈福者</span></a></td></tr>
